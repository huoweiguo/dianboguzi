...
<script lang="ts" setup>
  ...
  const mobileMenu = reactive([
    ...
    { title: '概念展示', intro: 'CONCEPTS', desc: '谷子、谷模与谷美', link: '/concept' },
    { title: '新闻', intro: 'NEWS', desc: '线上与线下的最新活动', link: '/news' },
    { title: '兑换码', intro: 'TOKENS', desc: '来兑换你最新获得的谷子吧', link: '/code' },
    { title: '联系我们', intro: 'CUSTOMER SERVICE', desc: '让我们听到您的声音', link: '/contactUs' }
  ])
